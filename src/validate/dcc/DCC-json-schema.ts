...
export const schema = {
  ...
  oneOf: [
    ...
    {
      required: ["ver", "nam", "dob", "t"],
    },
    {
      required: ["ver", "nam", "dob", "r"],
    },
  ],
  properties: {
    ver: {
  ...
  $defs: {
    ...
    vaccination_entry: {
      ...
      required: ["tg", "vp", "mp", "ma", "dn", "sd", "dt", "co", "is", "ci"],
      type: "object",
      properties: {
        tg: {
    ...
    "vaccine-prophylaxis": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.2",
      type: "string",
    },
    "vaccine-medicinal-product": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.3",
      type: "string",
    },
    "vaccine-mah-manf": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.4",
      type: "string",
    },
    country_vt: {
      description:
    ...
    "test-manf": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.8",
      type: "string",
    },
    "test-result": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.9",
      type: "string",
    },
    "test-type": {
      description:
        "EU eHealthNetwork: Value Sets for Digital Covid Certificates. version 1.0, 2021-04-16, section 2.7",
      type: "string",
    },
  },
};
